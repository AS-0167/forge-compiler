...
// Node *ast_int(long v) {
//     Node *n = ast_new(NODE_INT_LIT, 0, 0);
//     n->as.int_lit.value = v;
//     return n;
// }

// Node *ast_float(double v) {
//     Node *n = ast_new(NODE_FLOAT_LIT, 0, 0);
//     n->as.float_lit.value = v;
//     return n;
// }

// Node *ast_str(const char *s) {
//     Node *n = ast_new(NODE_STRING_LIT, 0, 0);
//     n->as.string_lit.value = strdup(s);
//     return n;
// }

// Node *ast_ident(const char *s) {
//     Node *n = ast_new(NODE_IDENTIFIER, 0, 0);
//     n->as.ident.name = strdup(s);
//     return n;
// }

// Node *ast_binary(NodeType type, int op, Node *left, Node *right) {
//     Node *n = ast_new(type, 0, 0);
//     n->as.binary.op = op;
...
#include <stdlib.h>
Node *ast_new(int t, int l, int c) { return malloc(sizeof(Node)); }
Node *ast_binary(int t, int op, Node *l, Node *r) { return malloc(sizeof(Node)); }
Node *ast_ident(char *s) { return malloc(sizeof(Node)); }
Node *ast_int(int v) { return malloc(sizeof(Node)); }
Node *ast_str(char *s) { return malloc(sizeof(Node)); }
